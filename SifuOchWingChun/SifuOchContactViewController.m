//
//  SifuOchContactViewController.m
//  SifuOchWingChun
//
...
#import "SifuOchContactViewController.h"

@interface SifuOchContactViewController ()

@end

@implementation SifuOchContactViewController
...
- (void)setFirstName:(NSString *)newFirstName {
    if(![_firstName isEqualToString:newFirstName]) {
        _firstName = newFirstName;
    }
}
- (void)setLastName:(NSString *)newLastName {
    if(![_lastName isEqualToString:newLastName]) {
        _lastName = newLastName;
    }
}
- (void)setEmail:(NSString *)newEmail {
    if(![_email isEqualToString:newEmail]) {
        _email = newEmail;
    }
}
- (void)setPhone:(NSString *)newPhone {
    if(![_phone isEqualToString:newPhone]) {
        _phone = newPhone;
    }
}
- (void)setMessage:(NSString *)newMessage {
    if(![_message isEqualToString:newMessage]) {
        _message = newMessage;
    }
}
